...
//        print("虚化后 ",bitmap);
    ...
    public  static  Bitmap doBlur(Bitmap originBitmap,int scaleRation,int blurRadius){

        Bitmap scaleBitmap=Bitmap.createScaledBitmap(originBitmap,
                originBitmap.getWidth()/scaleRation,
                originBitmap.getHeight()/scaleRation,
                false
        );
        Bitmap blurBitmap =doBlur(scaleBitmap,blurRadius,false);
        scaleBitmap.recycle();
        return blurBitmap;
    }
